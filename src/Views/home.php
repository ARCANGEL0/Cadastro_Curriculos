...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/fontawesome.min.css">
 ...
 <script src="https://kit.fontawesome.com/a89579e5da.js" crossorigin="anonymous"></script>
 ...
 #dPessoais, #formacao, #Outraformacao, #Experiencias {
 	display:none;
 }
...
function home() {
  ...
  document.getElementById("Outraformacao").style.display = "none";
...
function OutrasFormacoes() {
  ...
  document.getElementById("dPessoais").style.display = "none";
  document.getElementById("formacao").style.display = "none";
  document.getElementById("Outraformacao").style.display = "block";
  document.getElementById("Experiencias").style.display = "none";
...
<nav class="w3-sidebar w3-bar-block w3-center w3-blue ">
 <a onclick="home()" class="w3-bar-item w3-button w3-block n w3-cell w3-hover-light-grey w3-hovertext-cyan w3-text-light-grey">
 <i class="fa fa-home w3-xlarge"></i>
 <p>HOME</p>
 </a>
 <a onclick="DadosPessoais()" class="w3-bar-item w3-button w3-block n w3-cell w3-hover-light-grey w3-
hover-text-cyan w3-text-light-grey">
 <i class="fa fa-address-book-o w3-xlarge"></i>
 <p>Dados Pessoais</p>
 </a>
 <a onclick="Formacoes()" class="w3-bar-item w3-button w3-block n w3-cell w3-hover-light-grey w3-
hover-text-cyan w3-text-light-grey">
 <i class="fa fa-mortar-board w3-xlarge"></i>
 <p>Formação</p>
 </a>

 <a onclick="OutrasFormacoes()" class="w3-bar-item w3-button w3-block n w3-cell w3-hover-light-grey w3-
hover-text-cyan w3-text-light-grey">
 <i class="fa fa-vcard w3-xlarge"></i>
 <p>Outras formações</p>
 </a>

  <a onclick="Experiencias()" class="w3-bar-item w3-button w3-block n w3-cell w3-hover-light-grey w3-
hover-text-cyan w3-text-light-grey">
 <i class="fa fa-briefcase w3-xlarge"></i>
 <p>Experiências profissionais</p>
 </a>
  <form class="" action="" method="post">
    <button name="btnLogout" class="w3-bar-item w3-button w3-block n w3-cell w3-hover-light-grey w3-
   hover-text-cyan w3-text-light-grey">
...
<header class="w3-container w3-padding-32 w3-center " id="home">
 <h1>
 <img src="https://freepikpsd.com/media/2019/10/alimentos-enlatados-png-Transparent-Images.png" alt="Logo" class="w3-image" height="30%" width="20%">
 </br>
 </h1>
 <br>
...
placeholder="Descrição: Ex.: Técnico em Desenvolvimento de Sistemas - Centro Paula Souza">
 ...
 <div class="w3-row w3-section">
 <div class="w3-center" style="">
 <button name="btnAddFormacao" class="w3-button BTborder w3-block w3-blue w3-cell w3-
round-large" style="width: 20%;">
 ...
 if($results != null)
{
 ...
 echo '<tr>';
 echo '<td style="width: 30%;">'.$row->inicio.'</td>';
 echo '<td style="width: 30%;">'.$row->fim.'</td>';

echo '<td style="width: 65%;">'.$row->descricao.'</td>';
 echo '<td style="width: 5%;">
 <form action="/Controllers/navegacao.php" method="post">
...
<div class="w3-padding-128 w3-content w3-text-grey" id="Outraformacao" style="width: 135%;">
...
placeholder="">
 ...
 <div class="w3-rest">
 <input class="w3-input w3-border" name="txtDescOF" type="text"
placeholder="Descrição: Ex.: Curso de Inglês - Inglês City">
 ...
 <div class="w3-row w3-section">
 <div class="w3-center" style="">
 <button name="btnAddOF" class="w3-button BTborder w3-block w3-blue w3-cell w3-
round-large" style="width: 20%;">
 <i class="w3-xxlarge fa fa-user-plus"></i>
...
<tbody>
 ...
 <input type="hidden" name="idOF" value="'.$row->idformacaoAcademica.'">
...
<div class="w3-padding-128 w3-content w3-text-grey" id="Experiencias" style="width: 135%;">
...
70%;">
 ...
 <div class="w3-rest">
  <input class="w3-input w3-border w3-round-large" name="txtInicioEP"
type="date" placeholder="">
 </div>
 </div>
 <div class="w3-row w3-section w3-rest" style = "">
...
placeholder="">
 ...
 <div class="w3-rest">
 <input class="w3-input w3-border" name="txtEmpEP" type="text"
placeholder="Centro Paula Souza">
 ...
 <div class="w3-rest">
 <input class="w3-input w3-border" name="txtDescEP" type="text"
...
Desenvolvimento de Páginas WEB">
 ...
 <div class="w3-row w3-section">
 <div class="w3-center" style="">
 <button name="btnAddEP" class="w3-button BTborder w3-block w3-blue w3-cell w3-
round-large" style="width: 20%;">
 <i class="w3-xxlarge fa fa-user-plus"></i>
